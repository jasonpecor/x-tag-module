...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, 'CustomEvent', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_customEvent).default;
	  }
	});
	...
	Object.defineProperty(exports, 'Pseudo', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_pseudo).default;
	  }
	});
	
	var _xtag = __webpack_require__(2);
	
	Object.defineProperty(exports, 'xtag', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_xtag).default;
	  }
	});
	
	var _webComponent = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function CustomEvent(name, _ref) {
		var _ref$attach = _ref.attach,
		    attach = _ref$attach === undefined ? [] : _ref$attach,
		    _ref$condition = _ref.condition,
		    condition = _ref$condition === undefined ? null : _ref$condition,
		    _ref$capture = _ref.capture,
		    capture = _ref$capture === undefined ? null : _ref$capture;
	
		if (!_xtag2.default.customEvents[name]) _xtag2.default.customEvents[name] = { attach: attach, condition: condition, capture: capture };
		return name;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _xTagCore = __webpack_require__(4);
	...
	exports.default = function () {
		if (typeof window.__XTAG__ === 'undefined') window.__XTAG__ = _xTagCore2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Mixin(name) {
		...
		if (!_xtag2.default.mixins[name]) _xtag2.default.mixins[name] = options;
		return name;
	}
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Pseudo(name, _ref) {
		var _ref$action = _ref.action,
		    action = _ref$action === undefined ? null : _ref$action,
		    _ref$onAdd = _ref.onAdd,
		    onAdd = _ref$onAdd === undefined ? null : _ref$onAdd,
		    _ref$onRemove = _ref.onRemove,
		    onRemove = _ref$onRemove === undefined ? null : _ref$onRemove,
		    _ref$onCompiled = _ref.onCompiled,
		    onCompiled = _ref$onCompiled === undefined ? null : _ref$onCompiled;
	
		if (!_xtag2.default.pseudos[name]) _xtag2.default.pseudos[name] = { action: action, onAdd: onAdd, onRemove: onRemove, onCompiled: onCompiled };
		return name;
	}
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function WebComponent(name) {
		...
		return _xtag2.default.tags[name] || _xtag2.default.register(name, options);
	}
	module.exports = exports['default'];
...
;
//# sourceMappingURL=x-tag-module.js.map